...
void resetCompetitorButton(Button &b) { resetSolveState(false); }
...
void buttonsInit() {
  ...
  size_t dbgBtn = buttons.addMultiButton({BUTTON1, BUTTON2}, NULL,
                                         debugButton); // submit + penalty
  size_t calibrationBtn = buttons.addMultiButton(
      {BUTTON2, BUTTON3}, calibrationButton, NULL); // inspection + penalty
}
